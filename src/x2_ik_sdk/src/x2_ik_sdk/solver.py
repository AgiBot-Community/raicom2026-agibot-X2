...
# ============================================================
# 临时右 OmniPicker 抓取 TCP 标定
#
# 三组实机反标定平均值：
#   sample1 = [+0.06088058, +0.00718592, +0.09599444]
#   sample2 = [+0.04483524, -0.01135600, +0.08215233]
#   sample3 = [+0.04483962, -0.00856058, +0.10834079]
#
# 坐标系：
#   R_omnipicker_base_link local frame
#
# 含义：
#   R_omnipicker_base_link origin
#       ->
#   实际夹爪抓取中心 TCP
# ============================================================

USE_RIGHT_GRASP_TCP = False

RIGHT_GRASP_TCP_OFFSET_LOCAL = np.array(
    [
        +0.05018515,
        -0.00424355,
        +0.09549586,
    ...
    def solve_position(
        ...
        *,
        ...
        for iterations in range(1, self.config.max_iters + 1):
            ...
            offset_local = (
                RIGHT_GRASP_TCP_OFFSET_LOCAL
                if (
                    USE_RIGHT_GRASP_TCP
                    and side == ArmSide.RIGHT
                )
                else np.zeros(
                    3,
                    dtype=float,
