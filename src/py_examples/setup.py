...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "play_audio = py_examples.play_audio:main",
            ...
            "get_map = py_examples.get_map:main",
            "relocate = py_examples.relocate:main",
            "play_linkcraft = py_examples.play_linkcraft:main",
            "upper_body_command = py_examples.upper_body_command:main",
            "navigation = py_examples.navigation:main",
            "echo_fisheye_detection = py_examples.echo_fisheye_detection:main",
            "echo_obstacle_semantic = py_examples.echo_obstacle_semantic:main",
            "echo_grid_map = py_examples.echo_grid_map:main",
            "echo_obstacle_polygon = py_examples.echo_obstacle_polygon:main",
        ],
    },
)
